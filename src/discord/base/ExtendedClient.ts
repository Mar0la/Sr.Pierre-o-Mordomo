...
export class ExtendedClient<Ready extends boolean = boolean> extends Client<Ready> {
  public Commands = new Collection<string, Command['data']>()
  public Buttons = new Collection<string, Component['data'] & { type: 'Button' }>()
  public StringSelects = new Collection<string, Component['data'] & { type: 'StringSelect' }>()
  public RoleSelect = new Collection<string, Component['data'] & { type: 'RoleSelect' }>()
  public ChannelSelects = new Collection<string, Component['data'] & { type: 'ChannelSelect' }>()
  public UserSelects = new Collection<string, Component['data'] & { type: 'UserSelect' }>()
  public MentionableSelects = new Collection<string, Component['data'] & { type: 'MentionableSelect' }>()
  public Modals = new Collection<string, Component['data'] & { type: 'Modal' }>()
  constructor () {
    super({
  ...
  private async loadCommands () {
    ...
    for (const path of paths) {
      ...
      if (command.data.components) {
        command.data.components.forEach(async c => { await this.saveComponent(c) })
      }
    }
